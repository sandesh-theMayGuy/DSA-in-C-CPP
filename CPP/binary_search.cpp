...
// Binary Search using interation 
#include <bits/stdc++.h> 
using namespace std; 

// Iretative Binary Search function to find the index of an 
// element 'x' in a sorted array 'arr' if elements is present, otherwise it returns -1 

// low: The index of the first element in the current 
// sub-array high: The index of the last element in the current sub-array 
